...
var itemsArray = localStorage.getItem('test');
items = JSON.parse(itemsArray);

var skills = _.sortBy(_.union(_.flatMap(items, 'skills')));
console.log("skills",skills);

var friendsNames = _.flatMap(_.sortBy(items, 'friends'), 'name');
console.log('Sorted Names By Friends', friendsNames);

var usersFreinds = _.union(_.flatMap(_.flatMap(items, 'friends'), 'name'));
console.log('All Users Freinds', usersFreinds);
